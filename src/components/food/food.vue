	...
	<div class="food" v-show="showFlag" transition="move" v-el:food>
		<div class="food-content">
			...
			<div class="rating">
				...
				<ratingselect :desc="desc" :select-type="selectType" :only-content="onlyContent" :ratings="food.ratings"></ratingselect>
				<div class="reating-wrapper">
					<ul v-show="food.ratings && food.ratings.length">
						<li v-show="itemShow(rating.rateType, rating.text)" class="rating-item" v-for="rating in food.ratings">
							<div class="user">
...
<style rel="stylesheet" scoped lang="stylus">
