		...
		<div class="foods-wrapper" v-el:food-wrapper>
			<ul>
				<li v-for="item in goods" class="food-list food-list-hook">
					...
					<ul>
						<li v-for="food in item.foods" @click="select_food(food, $event)" class="food-item border-1px">
							<div class="icon">
	...
	export default {
		...
		methods : {
			selectMenu(index, event) {
				...
				let el = this.$els.foodWrapper.getElementsByClassName("food-list-hook")[index];
